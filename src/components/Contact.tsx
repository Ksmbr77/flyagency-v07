...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Redirect to WhatsApp - open in new tab
  ...
  return (
    <section id="contato" className="py-16 relative">
      <div className="absolute inset-0 bg-gradient-to-b from-white via-gray-100 to-white dark:from-black dark:via-primary-dark/20 dark:to-black" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto neo-blur rounded-2xl p-8 md:p-12">
          <div className="text-center mb-10 animate-fade-in">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">Entre em contato diretamente:</p>
          </div>
