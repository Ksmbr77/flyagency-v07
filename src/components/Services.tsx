...
const services = [
  {
    icon: <Shield className="w-12 h-12 text-[#7100FF]" />,
    title: "Tráfego Pago",
  ...
  {
    icon: <Zap className="w-12 h-12 text-[#7100FF]" />,
