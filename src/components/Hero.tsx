  ...
  return (
    <div className="min-h-[90vh] flex items-center relative overflow-hidden bg-white">
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-r from-primary-DEFAULT/5 to-secondary-DEFAULT/5 mix-blend-multiply" />
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center animate-fade-in [animation-delay:800ms] pb-8">
            <button 
              ...
              className="purple-gradient text-white px-8 py-4 rounded-full transition-all duration-300 flex items-center gap-2 group hover:shadow-lg hover:shadow-primary-DEFAULT/20 hover-shine transform hover:scale-105"
            >
            ...
            <a
              href="#cases"
              className="text-gray-800 hover:text-primary-DEFAULT transition-colors duration-300 flex items-center gap-2 group"
            >
